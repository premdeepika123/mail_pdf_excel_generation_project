    ...
    <?=$this->session->flashdata('message');?>
     ...
     <form method="post" action="<?= base_url('index.php/auth/resetlink')?>" >
       <div class ="form-group">
        <label for ="email" >Enter Your Email Address so that we will reset your password:</label>
        <input class="form-control" name="email_id" id="email_id" placeholder="Enter Valid Email" type="email" size="33" >
      </div>
